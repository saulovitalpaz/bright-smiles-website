                ...
                <Card className="border-primary/10 shadow-xl overflow-hidden backdrop-blur-sm bg-card/50">
                    <CardHeader className="text-center bg-gradient-to-b from-primary/5 to-transparent pb-8">
                        ...
                        <CardDescription className="text-base">
                            Conte-nos como foi sua experiência no Núcleo Odontológico.
                        </CardDescription>
                    </CardHeader>
                        ...
                        <form onSubmit={handleSubmit} className="space-y-8">
                                        ...
                                        return (
                                            ...
                                            >
                                                <div className={`p-3 rounded-2xl transition-colors ${isActive ? "bg-primary/20" : "bg-card group-hover:bg-secondary"
                                                    ...
                                                    <Icon className={`w-8 h-8 ${isActive ? emoji.color : "text-muted-foreground text-foreground"}`} />
                                                </div>
                            ...
                            <div className="grid gap-4">
                                <div className="grid gap-2">
                                    <Input
                                        placeholder="Assunto (ex: Atendimento, Limpeza, Botóx)"
                                ...
                                <div className="grid gap-2">
                                    <Textarea
                                        ...
                                        className="min-h-[120px] bg-background/50 border-primary/10 focus-visible:ring-primary resize-none text-base"
                                        required
                                    />
                                </div>
                            </div>
                            ...
                            <Button
                                type="submit"
                                className="w-full h-12 text-lg font-serif transition-all hover:shadow-[0_0_20px_rgba(var(--primary-rgb),0.3)]"
