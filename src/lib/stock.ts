...
export type StockProduct = { id: string; name: string; procedureType: FacialProcedureType; stockUnit: "ml" | "unit"; quantity: number; concentration: number | null; price: number; active: boolean; version: number };
